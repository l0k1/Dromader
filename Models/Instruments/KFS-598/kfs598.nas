...
var standby_freq = props.globals.getNode("/instrumentation/comm/frequencies/standby-mhz");
var active_freq = props.globals.getNode("/instrumentation/comm/frequencies/selected-mhz");
var volume = props.globals.initNode("/instrumentation/comm/volume",0.0,"DOUBLE",1);
var pwrbtn = props.globals.getNode("/instrumentation/comm/power-btn");
...
var init = setlistener("/sim/signals/fdm-initialized", func() {
  ...
  KFS_LCD_DISPLAY = LCDKFS598.new({"node": "kfs598LCD"});
  volume_knob(-0.05);
  update_bottom(sprintf("%.2f",standby_freq.getValue()));
  update_top(sprintf("%.2f",active_freq.getValue()));
});
